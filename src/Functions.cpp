...
static std::shared_ptr<arrow::Table>
        assignFieldNames(ArrayType *field_names, const std::shared_ptr<arrow::Table> targetTable)
{
...
static int64_t convertCsvToParquet(const char *src_filepath,
...
Datum convert_csv_to_parquet(PG_FUNCTION_ARGS)
{
    ...
    const int64_t numRows =
            convertCsvToParquet(src_filepath, target_filepath, compression_type, field_names);
